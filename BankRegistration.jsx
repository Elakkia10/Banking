  ...
  return (
    <>
      ...
      <div>
        ...
        <button className="green-button" onClick={handleUpdate}>Update</button>
        <button className="green-button" onClick={handleDelete}>Delete</button>
      </div>
      {isDeleteConfirmationOpen && (
        <div className="confirmation-modal">
          <p>Are you sure you want to delete?</p>
          <button className="green-button" onClick={confirmDelete}>Yes</button>
          <button className="green-button" onClick={cancelDelete}>No</button>
        </div>
      )}
    </>
  );
