...
function Deposit() {
  ...
  const transactionData = {
    ...
    fetch(`https://firestore.googleapis.com/v1/projects/elakkia-bank/databases/(default)/documents/Account`)
      .then(response => {
        if (!response.ok) {
      ...
      .then(data => {
        ...
        return fetch(`https://firestore.googleapis.com/v1/projects/elakkia-bank/databases/(default)/documents/Account/${docId}`, {
          method: 'PATCH',
          headers: {
      ...
      //   return fetch(`https://firestore.googleapis.com/v1/projects/rajeshbank1/databases/(default)/documents/customerAccounts`);
      // })
      // .then(response => {
      //   if (!response.ok) {
      ...
      //   return fetch(`https://firestore.googleapis.com/v1/projects/rajeshbank1/databases/(default)/documents/customerAccounts/${docId}`, {
      //     method: 'PATCH',
      //     headers: {
      //       'Content-Type': 'application/json'
      //     },
      ...
      return fetch(`https://firestore.googleapis.com/v1/projects/elakkia-bank/databases/(default)/documents/Transactions`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
